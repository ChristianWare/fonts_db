        ...
        <div className={styles.content}>
          ...
          <div className={styles.right}>
            ...
            <p className={styles.copy}>
              ...
              work. So I built the platform from the ground up, deployed it with
              a real operator in Phoenix, and refined it until it worked the way
              the business needed it to. When you come onboard, you&apos;re
              getting a platform that&apos;s already handling real bookings,
              real drivers, and real corporate clients — not a prototype.
            </p>
          </div>
        </div>
      </LayoutWrapper>
