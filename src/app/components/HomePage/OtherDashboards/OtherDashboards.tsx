...
const cards: Card[] = [
  {
    ...
    body: "Every driver gets their own dedicated portal to see assigned trips, update status in real time, and track earnings — all from their phone.",
    highlights: [
  ...
  },
  {
    ...
    heading: "An experience worth coming back to.",
    body: "Every rider gets a personal customer portal — a branded, professional space where clients manage their entire relationship with your company.",
    highlights: [
  ...
  },
  {
    ...
    body: "Your platform is built to attract corporate clients, onboard them cleanly, and give them everything they need to keep booking.",
    highlights: [
